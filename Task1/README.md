...
5. Визуализируйте результаты анализа в виде mindmap.
    ...
    - Для каждой категории данных укажите риск и присвойте ему оценку. На последнем уровне объясните, почему вы оценили риск именно так.

Когда mindmap будет готов, загрузите его в директорию Task1 вашего репозитория.

# Решение

[Mindmap.drawio](/Task1/mindmap.ProDevelopment.DataSecurity.checklist.drawio)
![Mindmap](/Task1/mindmap1.png)
